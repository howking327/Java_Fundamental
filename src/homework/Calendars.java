...
public class Calendars {
	...
	*/
	public void print(int year, int month, int day) {
		...
		String message = null;
		if (dayOfWeek == Calendars.MONDAY) {
			message = "월요일";
		} else if (dayOfWeek == Calendars.TUESDAY) {
			message = "화요일";
		} else if (dayOfWeek == Calendars.WEDNESDAY) {
			message = "수요일";
		} else if (dayOfWeek == Calendars.THURSDAY) {
			message = "목요일";
		} else if (dayOfWeek == Calendars.FRIDAY) {
			message = "금요일";
		} else if (dayOfWeek == Calendars.SATURDAY) {
			message = "토요일";
		} else if (dayOfWeek == Calendars.SUNDAY) {
			message = "일요일";
		}
