...
public class MulticastClient implements ActionListener{
	...
	public MulticastClient(String id, String ip, int port){
		...
		jta.setBackground(new Color(155,187,212));
		...
		jframe.pack();
		jframe.setResizable(true); //사이즈 조절 free
	...
	public static void main(String[] args) {
		...
		new MulticastClient("howking327","192.168.0.203",3000).connect();
	}
